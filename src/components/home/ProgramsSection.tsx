...
export default function ProgramsSection() {
  return (
    <section className="py-20 bg-vra-lightPink">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {educationLevels.map((level, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-3 text-vra-darkBlue">{level.title}</h3>
                <p className="text-vra-darkBlue/70 mb-4">{level.description}</p>
                
                <div className="mb-6 space-y-2">
                  {level.age && (
                    <div className="text-sm text-vra-darkBlue/60">
